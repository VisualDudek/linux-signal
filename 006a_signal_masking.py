...
critical_task_finished = threading.Event() 
...
def signal_waiter_thread():
    ...
    # --- WAIT FOR CRITICAL TASK TO FINISH ---
    print("[HANDLER] Waiting for critical task to complete...")
    critical_task_finished.wait()  # Block until critical task sets this event
...
def critical_task_thread():
    ...
    try:
        ...
        # Ensure the event is set even if an exception occurs
        print("[WORKER THREAD] Setting completion event.")
        critical_task_finished.set()
